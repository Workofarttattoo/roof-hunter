...
**State / regional GIS** — often **beats NAIP locally** (Texas STRATMAP, Florida off FDOT hubs, etc.). Search “`(your state)` orthoimagery GIS download`” and prefer **_leaf-off / spring** or **post-storm** captures when available.
...
- Imagery is distributed in **fixed chip sizes** (commonly cited **1024×1024** at varying native GSD depending on source); use official download mirrors you trust (e.g. hoster pages change — search “xBD dataset download” and prefer **academic / AWS / established mirrors**).
...
- Example project listing pattern: [DesignSafe PRJ-3563 — Ida-BD](https://www.designsafe-ci.org/data/browser/public/designsafe.storage.published/PRJ-3563) (exact layout varies; use their browser search).

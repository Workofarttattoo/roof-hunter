...
class ThreddsMRMSBuilder:
    """
    Legacy THREDDS / local NetCDF MRMS experiment.

    For **production** operational MESH ingestion, use `mrms_mesh_ingest.py` and
    `requirements-radar.txt` (NCEP HTTPS GRIB2 → same `storms` table as `live_hail_ingest.py`).
    """
    def __init__(self):
